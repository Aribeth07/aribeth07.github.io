...
_（Michael 可以引爆了，如果不选择马上引爆，则出现以下文本 ）_
...
      _（如果玩家此时还是没有打电话，Jay 会大怒并冲出会场，任务失败）_

_（Michael 给 Jay 打电话）_
...
Click [here](https://www.grandtheftwiki.com/Friend_Request/Script) to see full script of the mission (English)
